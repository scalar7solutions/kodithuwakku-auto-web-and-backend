          ...
          <div class="card-body mb-4">
              ...
              <div class="row input-fields gy-4 px-3">
                <div class="col-12">
                  <div class="input-group border">
                    <input type="text" class="form-control bg-light border-0 py-3 px-4" placeholder="Username"
                      id="username" v-model="form.username" />
                    <span class="input-group-text border-0"><i class="fa-solid fa-user pe-3"
                        style="color: #6a3090"></i></span>
                  </div>
                </div>
                <div class="col-12">
                  <div class="input-group border">
                    ...
                    <label type="button" class="input-group-text border-0 border-radius-custom" for="chk"><i
                ...
                <div class="col-6 text-end">
                  <Link style="font-size: small; color: #6a3090" :href="route('forgotpassword')">Forgot Password</Link>
                </div>
                <div class="col-12 mt-4">
                  <button class="btn btn-primary w-100 py-2 login-btn border-0" style="background-color: #6a3090"
            ...
            <div class="row px-4 mt-2">
              <div class="col-12 mt-2">
                <small>
                  No Account yet?
                  <Link style="color: #6a3090" :href="route('register')">Register</Link>
                </small>
              </div>
