        ...
        <div class="card mb-4">
          <div class="card-header pb-0">
            ...
            <div class="d-flex">
              <Link
                ...
                :href="route('vehicle_model.create')"
                v-if="$root.hasPermission('vehicle_model.create')"
              >
          ...
          <div class="card-body">
            <data-table
              ref="datatable"
              :id="'mytable'"
              :url="route('vehicle.model.getdata')"
              :columns="columns"
...
export default {
  ...
  mounted() {
    ...
    $("#mytable tbody").on("click", "tr .action_edit", (evt) => {
      ...
      this.$inertia.visit(route("vehicle_model.edit", id));
    });
  ...
  methods: {
    ...
    updateStatus(id, status) {
      ...
      this.form.put(route("vehicle_model.status.update"), {
        preserveScroll: true,
        onSuccess: () => {
          this.form.reset();
          this.reloadTable();
    ...
    deleteSelectedItems() {
      this.form
        ...
        .post(route("vehicle_model.delete"), {
          onSuccess: () => {
            this.resetForm();
            this.reloadTable();
            this.$root.showMessage(
