          ...
          <div class="card-header pb-0">
            ...
            <div class="d-flex">
              <Link
                ...
                :href="route('ourcustomer.create')"
                v-if="$root.hasPermission('ourcustomer.create')"
              >
...
export default {
  ...
  mounted() {
    ...
    $("#mytable tbody").on("click", "tr .action_edit", (evt) => {
      ...
      this.$inertia.visit(route("ourcustomer.edit", id));
    });
    ...
    $("#mytable tbody").on(
      ...
      (evt) => {
        ...
        if ($(evt.target).prop("checked") && !self.selectedRows.includes(checkedVal)) {
          self.getSelectedItems(checkedVal);
        } else {
          self.removeUnselectedItem(checkedVal);
        }
      }
    );
  },
  ...
  methods: {
    ...
    updateStatus(id, status) {
      ...
      this.form.put(route("ourcustomer.change.status"), {
        preserveScroll: true,
        onSuccess: () => {
          this.form.reset();
          this.reloadTable();
