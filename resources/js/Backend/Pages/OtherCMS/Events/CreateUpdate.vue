          ...
          <form id="formAccountSettings" @submit.prevent="submit">
            <div class="row">
              <div class="mb-3 col-md-6">
                <label for="name" class="form-label">News / Event Title</label>
                <input
                  class="form-control"
                  type="text"
                  id="name"
...
export default {
  ...
  mounted() {
    ...
    if (this.event) {
      ...
      this.form.editorContent = this.event.editorContent;
    }
  ...
  computed: {
    image() {
      return this.event ? this.event.media.length > 0 ? this.event.media[0].original_url : "" : "";
    },
  },
  methods: {
    submit() {
