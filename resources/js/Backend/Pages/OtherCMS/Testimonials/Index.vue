        ...
        <div class="card mb-4">
          <div class="card-header pb-0">
            ...
            <div class="d-flex">
              <Link
                ...
                v-if="$root.hasPermission('testimonials.create')"
              >
          ...
          <div class="card-body">
            <data-table
              ref="datatable"
              :id="'mytable'"
              :url="route('testimonials.getdata')"
              :columns="columns"
...
export default {
  ...
  mounted() {
    ...
    $("#mytable tbody").on("click", "tr .action_edit", (evt) => {
      ...
      this.$inertia.visit(route("testimonials.edit", id));
    });
  ...
  methods: {
    ...
    updateStatus(id, status) {
      ...
      this.form.put(route("testimonials.status.update"), {
        preserveScroll: true,
        onSuccess: () => {
          this.form.reset();
          this.reloadTable();
