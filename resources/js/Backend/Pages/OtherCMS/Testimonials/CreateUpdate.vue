    ...
    <div class="row">
      <div class="card mb-4">
        <div class="card-header pb-0">
          <h5>Vehicle Testimonials</h5>
          <p>Manage Vehicle Testimonials.</p>
        </div>
        <hr />
        <div class="card-body">
...
export default {
  ...
  mounted() {
    ...
    if (this.testimonial) {
      this.form.id = this.testimonial.id;
      this.form.name = this.testimonial.name;
      this.form.status = this.testimonial.status;
      this.form.editorContent = this.testimonial.editorContent;
    }
  ...
  computed: {
    image() {
      return this.testimonial
        ? this.testimonial.media.length > 0
          ? this.testimonial.media[0].original_url
          : ""
        : "";
    },
  },
