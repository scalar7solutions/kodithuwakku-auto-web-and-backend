          ...
          <div class="card-header pb-0">
            ...
            <div class="d-flex">
              <Link
                ...
                :href="route('homebanner.create')"
                v-if="$root.hasPermission('homebanner.create')"
              >
...
export default {
  ...
  mounted() {
    ...
    $("#mytable tbody").on("click", "tr .action_edit", (evt) => {
      ...
      this.$inertia.visit(route("homebanner.edit", id));
    });
  ...
  methods: {
    ...
    updateStatus(id, status) {
      ...
      this.form.put(route("homebanner.change.status"), {
        preserveScroll: true,
        onSuccess: () => {
          this.form.reset();
          this.reloadTable();
