...
class RolesPermissionSeeder extends Seeder
{
    ...
    public function run()
    {
     ...
     //Country
     ['section_name' => 'country', 'name' => 'country.view'],
     ['section_name' => 'country', 'name' => 'country.create'],
     ['section_name' => 'country', 'name' => 'country.edit'],
     ['section_name' => 'country', 'name' => 'country.delete'],
